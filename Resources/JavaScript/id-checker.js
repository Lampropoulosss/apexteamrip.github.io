...
function convert(id) {
	...
	document.getElementById('i-date24').innerHTML = timestamp.format('MM-DD-YYYY, HH:mm:ss');
	document.getElementById('i-date12').innerHTML = timestamp.format('MM-DD-YYYY, h:mm:ss A');
